package co.nz.enhanceconsulting.pageobjects;
...
public class PassionTeaCoWelcomePO<M extends WebElement> extends PassionTeaCoBasePO<M> {
    ...
    public static enum WELCOME_PAGE_IMG { PASSION_TEA_CO, LEAF, ORGANIC, TEA_CUP, HERBAL_TEA, LOOSE_TEA, FLAVORED_TEA };
    public static enum MENU_LINKS { MENU, MORE_1, MORE_2, HERBAL_TEA, LOOSE_TEA, FLAVORED_TEA, SEE_COLLECTION1, SEE_COLLECTION2, SEE_COLLECTION3 };
    ...
    public void navigateMenuLink(MENU_LINKS link, String title) throws Exception {
        ...
        try {
            ...
            BrowserUtils.waitFor(MENU_TITLE, GlobalVARS.TIMEOUT_ELEMENT);
        }
