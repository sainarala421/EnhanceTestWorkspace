 ...
 *
 */
public class TestNGConsoleRunner extends TestListenerAdapter {
    ...
    public void onTestStart(ITestResult tr) {
        if ( logFile == null ) {
            logFile = GlobalVARS.LOGFILE_PATH + GlobalVARS.SUITE_NAME + "-" + new SimpleDateFormat("MM.dd.yy.HH.mm.ss").format(new Date()) + ".log";
        }
    ...
    public void writeTestngLog(String logFile,String line) {
        ...
        Date date = new Date();
        File directory = new File(GlobalVARS.LOGFILE_PATH);
