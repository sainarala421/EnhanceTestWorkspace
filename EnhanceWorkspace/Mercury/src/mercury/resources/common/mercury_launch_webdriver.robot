*** Variables ***
${MERCURY_BASE_URL}          https://www.mercury.co.nz
...
Browser Is Launched
    ...
    ...    Should Contain    ${SUITE DOCUMENTATION.lower()}    product:mercury
...
Setup Global Timeout
    Run Keyword If    '${MERCURY_BASE_URL}'!='https://www.mercury.co.nz'
