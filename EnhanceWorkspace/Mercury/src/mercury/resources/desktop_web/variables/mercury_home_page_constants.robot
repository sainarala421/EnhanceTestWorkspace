...
@{MERCURY_GLOBAL_PRIMARY_NAV_CORE_ELEMENTS_LIST}    ${MERCURY_PRIMARY_NAV_PRODUCTS_LINK}    ${MERCURY_PRIMARY_NAV_PRICING_LINK}
...                                                 ${MERCURY_PRIMARY_NAV_JOIN_LINK}    ${MERCURY_PRIMARY_NAV_MOVING_HOUSE_LINK}
...                                                 ${MERCURY_PRIMARY_NAV_MY_ACCOUNT_LINK}    ${MERCURY_PRIMARY_SEARCH_BUTTON}

${MERCURY_GLOBAL_PRIMARY_NAV}                       css = #nav-primary
${MERCURY_PRIMARY_NAV_PRODUCTS_LINK}                ${MERCURY_GLOBAL_PRIMARY_NAV} a[href="/Products"]
${MERCURY_PRIMARY_NAV_PRICING_LINK}                 ${MERCURY_GLOBAL_PRIMARY_NAV} a[href="/pricing"]
${MERCURY_PRIMARY_NAV_JOIN_LINK}                    ${MERCURY_GLOBAL_PRIMARY_NAV} a[href="/join"]
${MERCURY_PRIMARY_NAV_MOVING_HOUSE_LINK}            ${MERCURY_GLOBAL_PRIMARY_NAV} a[href="/Moving-House"]
${MERCURY_PRIMARY_NAV_MY_ACCOUNT_LINK}              ${MERCURY_GLOBAL_PRIMARY_NAV} a[href="/MyAccount"]
...
@{MERCURY_GLOBAL_SECONDARY_NAV_CORE_ELEMENTS_LIST}     ${MERCURY_SECONDARY_NAV_ELECTRICITY_LINK}    ${MERCURY_SECONDARY_NAV_GAS_LINK}
...                                                    ${MERCURY_SECONDARY_NAV_ELECTRIC_TRANSPORT_LINK}    ${MERCURY_SECONDARY_NAV_ELECTRIC_VEHICLES_LINK}
...                                                    ${MERCURY_SECONDARY_NAV_ELECTRIC_BIKES_LINK}    ${MERCURY_SECONDARY_AIRPOINTS_LINK}
...                                                    ${MERCURY_SECONDARY_SOLAR_LINK}
${MERCURY_GLOBAL_SECONDARY_NAV}                        css = #nav-secondary
${MERCURY_SECONDARY_NAV_ELECTRICITY_LINK}              ${MERCURY_GLOBAL_SECONDARY_NAV} a[href="/Products/Electricity"]
${MERCURY_SECONDARY_NAV_GAS_LINK}                      ${MERCURY_GLOBAL_SECONDARY_NAV} a[href="/Products/Gas"]
${MERCURY_SECONDARY_NAV_ELECTRIC_TRANSPORT_LINK}       ${MERCURY_GLOBAL_SECONDARY_NAV} a[href="/Products/E-transport"]
${MERCURY_SECONDARY_NAV_ELECTRIC_VEHICLES_LINK}        ${MERCURY_GLOBAL_SECONDARY_NAV} a[href="/Products/electric-vehicles"]
${MERCURY_SECONDARY_NAV_ELECTRIC_BIKES_LINK}           ${MERCURY_GLOBAL_SECONDARY_NAV} a[href="/Products/Electric-Bikes"]
${MERCURY_SECONDARY_AIRPOINTS_LINK}                    ${MERCURY_GLOBAL_SECONDARY_NAV} a[href="/Products/Airpoints"]
${MERCURY_SECONDARY_SOLAR_LINK}                        ${MERCURY_GLOBAL_SECONDARY_NAV} a[href="/Products/Solar"]
